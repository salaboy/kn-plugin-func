...
func TestClient_New(t *testing.T) {
	...
	if err := client.New(context.Background(), fn.Function{Root: root, Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime}}); err != nil {
		t.Fatal(err)
	}
}
...
func TestClient_New_WritesTemplate(t *testing.T) {
	...
	if err := client.New(context.Background(), fn.Function{Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime}, Root: root}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_RepositoriesExtensible(t *testing.T) {
	...
	if err := client.New(context.Background(), fn.Function{Root: root, Runtime: fn.FunctionRuntimeSpec{Runtime: "test"}, Template: "customTemplateRepo/tplc"}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_RuntimeNotFoundError(t *testing.T) {
	...
	err := client.New(context.Background(), fn.Function{Root: root, Runtime: fn.FunctionRuntimeSpec{Runtime: "invalid"}})
...
func TestClient_New_RuntimeNotFoundCustom(t *testing.T) {
	...
	f := fn.Function{Root: root, Runtime: fn.FunctionRuntimeSpec{Runtime: "python"}, Template: "customTemplateRepo/event"}
...
func TestClient_New_TemplateNotFoundError(t *testing.T) {
	...
	f := fn.Function{Root: root, Runtime: fn.FunctionRuntimeSpec{Runtime: "go"}, Template: "invalid"}
	err := client.New(context.Background(), f)
...
func TestClient_New_TemplateNotFoundCustom(t *testing.T) {
	...
	f := fn.Function{Root: root, Runtime: fn.FunctionRuntimeSpec{Runtime: "test"}, Template: "customTemplateRepo/invalid"}
...
func TestClient_New_Named(t *testing.T) {
	...
	if err := client.New(context.Background(), fn.Function{Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime}, Root: root, Name: name}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_ImageNameDerived(t *testing.T) {
	...
	if f.Runtime.Image != expected {
		t.Fatalf("expected image '%v' got '%v'", expected, f.Runtime.Image)
	}
}
...
func TestClient_New_Delegation(t *testing.T) {
	...
	pusher.PushFn = func(f fn.Function) (string, error) {
		if f.Runtime.Image != expectedImage {
			t.Fatalf("pusher expected image '%v', got '%v'", expectedImage, f.Runtime.Image)
		}
		return "", nil
	}
	...
	deployer.DeployFn = func(f fn.Function) error {
		...
		if f.Runtime.Image != expectedImage {
			t.Fatalf("deployer expected image '%v', got '%v'", expectedImage, f.Runtime.Image)
		}
		return nil
	}
...
func TestClient_Update(t *testing.T) {
	...
	deployer.DeployFn = func(f fn.Function) error {
		...
		if f.Runtime.Image != expectedImage {
			t.Fatalf("updater expected image '%v', got '%v'", expectedImage, f.Runtime.Image)
		}
		return nil
	}
...
func TestClient_Remove_ByName(t *testing.T) {
	...
	if err := client.Create(fn.Function{Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime}, Root: root}); err != nil {
		t.Fatal(err)
	}
...
func TestClient_New_BuildpacksPersisted(t *testing.T) {
	...
	if err := client.New(context.Background(), fn.Function{
		Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime},
		Root:    root,
		Build:   fn.FunctionBuildSpec{Buildpacks: buildpacks},
	}); err != nil {
		t.Fatal(err)
	}
	f, err := fn.NewFunction(root)
...
func TestClient_Invoke_HTTP(t *testing.T) {
	...
	f := fn.Function{Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime}, Root: root, Template: "http"}
	if err := client.New(context.Background(), f); err != nil {
		t.Fatal(err)
	}
...
func TestClient_Invoke_CloudEvent(t *testing.T) {
	...
	f := fn.Function{Runtime: fn.FunctionRuntimeSpec{Runtime: TestRuntime}, Root: root, Template: "cloudevents"}
	if err := client.New(context.Background(), f); err != nil {
		t.Fatal(err)
	}
