...
func TestRepository_Inheritance(t *testing.T) {
	...
	if fA.Runtime.HealthEndpoints.Readiness != "/repoReadiness" {
		t.Errorf("Repository-level HealthEndpoint not loaded to template, got %q", fA.Runtime.HealthEndpoints.Readiness)
	}
	...
	if fB.Runtime.HealthEndpoints.Readiness != "/runtimeReadiness" {
		t.Errorf("Runtime-level HealthEndpoint not loaded to template, got %q", fB.Runtime.HealthEndpoints.Readiness)
	}
	...
	if fC.Runtime.HealthEndpoints.Readiness != "/templateReadiness" {
		t.Fatalf("Template-level HealthEndpoint not loaded to template, got %q", fC.Runtime.HealthEndpoints.Readiness)
	}
